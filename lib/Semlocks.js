 ...
 *      If this release argument is specified in the callback function's
 *      signature, the locks MUST be manually released in order for them to be
 *      acquired by other requests. The only exception is if the `ttl` option
 *      is specified, but that should not be utilized for regular operation.
